...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Oleksandra\PycharmProjects\pythonPr1\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Oleksandra\PycharmProjects\pythonPr1\venv\Scripts\deactivate.nu'
